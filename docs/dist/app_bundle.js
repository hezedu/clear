...
/***/ function(module, exports, __webpack_require__) {
	...
	var _clear = __webpack_require__(240);
	...
	_clear2.default.staticPath = mount.getAttribute('staticpath') || '/';

	_reactDom2.default.render(React.createElement(_reactRouter.Router, { history: history, routes: _router2.default }), mount);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var navRoutes = exports.navRoutes = [{ path: 'env', component: layout.Left, title: '环境',
	  childRoutes: [{ path: 'about', component: layout.About, title: 'about',
	    childRoutes: [{ path: 'about2', component: layout.About, title: 'test' }] }, { path: 'css', component: layout.About, title: 'css' }] }, { path: 'study', component: layout.study, title: '学习' }];

	exports.default = {
	  path: '/', component: layout.Root,
	  childRoutes: [{ path: '/login', component: _login.LoginBox }, { path: '/', component: layout.Top,
	    childRoutes: [{ indexRoute: { component: layout.Home } }, { path: '/', onEnter: _clear2.default.isLogin,
	      childRoutes: navRoutes }] }, { path: '*', component: layout.Error }]
	};

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\duwei\\git\\clear\\node_modules\\.npminstall\\react-hot-loader\\1.3.0\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "router.conf.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Error = exports.Study = exports.About = exports.Left = exports.Home = exports.Top = exports.Root = undefined;
	...
	var Root = exports.Root = function (_Component) {
	  ...
	  (0, _createClass3.default)(Root, [{
	    ...
	    value: function componentWillMount() {
	      _clear2.default.router = this.context.router;
	...
	_clear2.default.isLogin = function (nextState, replace) {
	...
	var Top = exports.Top = function (_Component2) {
	  ...
	  (0, _createClass3.default)(Top, [{
	    ...
	    value: function NavList() {
	      var arr = [];
	      _router.navRoutes.forEach(function (v, i) {
	        var link = '/' + v.path;
	        ...
	        arr[i] = React.createElement(
	          _reactRouter.Link,
	          { to: link, key: v.path, activeClassName: _style2.default.active },
	          v.title
	        );
	      });
	      return arr;
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement('img', { src: _clear2.default.staticPath + '/static/pinned-octocat.svg' })
	            )
	          )
	        ),
	        this.props.children
	...
	var tree = function tree(arr, rpath) {
	  var arr2 = [];
	  arr.forEach(function (v, i) {
	    v.link = rpath + '/' + v.path;
	    var childRoutes = '';
	    if (v.childRoutes) {
	      childRoutes = React.createElement(
	        'ul',
	        null,
	        tree(v.childRoutes, v.link)
	      );
	    }
	    arr2[i] = React.createElement(
	      'li',
	      { key: v.path },
	      React.createElement(
	        _reactRouter.Link,
	        { to: v.link, activeClassName: _style2.default.active },
	        v.title
	      ),
	      childRoutes
	    );
	...
	var Left = exports.Left = function (_Component4) {
	  ...
	  (0, _createClass3.default)(Left, [{
	    ...
	    //出现左导航，容器为：main。
	    value: function NavList() {
	      var key = this.props.route.path;
	      var data = (0, _find2.default)(_router.navRoutes, { path: key }).childRoutes;
	...
	var Study = exports.Study = function (_Component6) {
	  (0, _inherits3.default)(Study, _Component6);

	  function Study() {
	    (0, _classCallCheck3.default)(this, Study);
	    return (0, _possibleConstructorReturn3.default)(this, (Study.__proto__ || (0, _getPrototypeOf2.default)(Study)).apply(this, arguments));
	  }
	  ...
	  (0, _createClass3.default)(Study, [{
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        _reactRouter.Link,
	        { to: this.props.route.path + '/Study', activeClassName: _style2.default.active },
	        'About'
	      );
	    }
	  }]);
	...
	var Error = exports.Error = function (_Component7) {
	  (0, _inherits3.default)(Error, _Component7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/.npminstall/css-loader/0.24.0/css-loader/index.js?modules&importLoaders=1&localIdentName=[local]___[hash:base64:5]!./../../node_modules/.npminstall/postcss-loader/0.11.1/postcss-loader/index.js!./../../node_modules/.npminstall/sass-loader/4.0.1/sass-loader/index.js!./style.scss", function() {
				var newContent = require("!!./../../node_modules/.npminstall/css-loader/0.24.0/css-loader/index.js?modules&importLoaders=1&localIdentName=[local]___[hash:base64:5]!./../../node_modules/.npminstall/postcss-loader/0.11.1/postcss-loader/index.js!./../../node_modules/.npminstall/sass-loader/4.0.1/sass-loader/index.js!./style.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createFind = __webpack_require__(358),
	    findIndex = __webpack_require__(459);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseIteratee = __webpack_require__(359),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseIsMatch = __webpack_require__(361),
	    ...
	    matchesStrictComparable = __webpack_require__(440);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stack = __webpack_require__(362),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListCache = __webpack_require__(363),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assocIndexOf = __webpack_require__(366);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isFunction = __webpack_require__(379),
	    ...
	    isMasked = __webpack_require__(381),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var root = __webpack_require__(383);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Hash = __webpack_require__(389),
	    ListCache = __webpack_require__(363),
	    Map = __webpack_require__(376);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Symbol = __webpack_require__(410),
	    Uint8Array = __webpack_require__(411),
	    eq = __webpack_require__(367),
	    equalArrays = __webpack_require__(404),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataView = __webpack_require__(428),
	    ...
	    baseGetTag = __webpack_require__(432),
	    toSource = __webpack_require__(385);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(module) {var freeGlobal = __webpack_require__(384);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var castPath = __webpack_require__(444),
	    isKey = __webpack_require__(450),
	    toKey = __webpack_require__(451);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Symbol = __webpack_require__(410),
	    isSymbol = __webpack_require__(449);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isObjectLike = __webpack_require__(341);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isSymbol = __webpack_require__(449);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseHasIn = __webpack_require__(453),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseFindIndex = __webpack_require__(460),
	    baseIteratee = __webpack_require__(359),
	    toInteger = __webpack_require__(461);
